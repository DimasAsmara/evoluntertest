                ...
                <div class="card mb-5 mb-xl-8">
                    <div class="d-flex flex-stack flex-wrap ms-10 mt-10">
                        ...
                        <div class="page-title d-flex flex-column align-items-start">
                            <!--begin::Title-->
                            <h1 class="d-flex text-dark fw-bold m-0 fs-3">Pendukung</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-gray-600">Pendukung</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                    ...
                    <div class="card-header border-0 pt-5">
                        <div class="d-flex align-items-center position-relative me-3 search_mekanik w-300px">
                            ...
                            <input type="search" name="search" value="<?= $search; ?>" class="form-control form-control-solid w-250px ps-13" aria-label="Cari Pendukung" aria-describedby="button-cari-pendukung" placeholder="Cari Pendukung" autocomplete="off">
                            <button type="button" onclick="search()" class="btn btn-primary d-none" type="button" id="button-cari-pendukung">
                        ...
                        <div class="card-toolbar">
                            <?php if ($this->session->userdata('vol_id_role') == 2) : ?>
                                ...
                                <div class="d-none justify-content-end" id="sistem_drag">
                                    <button type="button" id="btn_hapus" onclick="submit_form(this,'#reload_table',0,'/deleted',true,true)" data-message="Apakah anda yakin akan menghapus data pendukung? pendukung yang di hapus tidak akan bisa di kembalikan" class="btn btn-sm btn-light-danger me-3">Hapus</button>
                                </div>
                            <?php endif; ?>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px filter_mekanik" data-kt-menu="true">
                                    ...
                                    <div class="px-7 py-5" style="overflow-y: scroll;height : 250px">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select name="id_kelurahan" class="form-select form-select-solid filter-input" data-control="select2" data-placeholder="Pilih kelurahan">

                                                <?php if ($kelurahan) : ?>
                                                    <option value="all">Semua</option>
                                                    <?php foreach ($kelurahan as $row) : ?>
                                                        <option value="<?= $row->id_kelurahan; ?>" <?php if ($this->input->get('id_kelurahan') == $row->id_kelurahan) {
                                                                                                        echo 'selected';
                                                                                                    } ?>><?= $row->nama; ?></option>
                                                    <?php endforeach; ?>
                                                <?php else : ?>
                                        ...
                                        <?php if ($this->session->userdata('vol_id_role') == 2) : ?>
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <select name="id_relawan" class="form-select form-select-solid filter-input" data-control="select2" data-placeholder="Pilih relawan">

                                                    <?php if ($relawan) : ?>
                                                        <option value="all">Semua</option>
                                                        <?php foreach ($relawan as $row) : ?>
                                                            <option value="<?= $row->id_user; ?>" <?php if ($this->input->get('id_user') == $row->id_user) {
                                                                                                        echo 'selected';
                                                                                                    } ?>><?= $row->nama; ?></option>
                                                        <?php endforeach; ?>
                                                    <?php else : ?>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <?php
                                            if ($this->session->userdata('vol_id_role') == 2) {
                                                $filter = "filter(['id_kelurahan','id_relawan','data','umur_minimal','umur_maximal'])";
                                            } else {
                                                $filter = "filter(['id_kelurahan','data','umur_minimal','umur_maximal'])";
                                            }
                                            ?>
                                            <button type="button" onclick="<?= $filter; ?>" class="btn btn-primary fw-semibold px-6">Terapkan</button>
                                        </div>
                                        <!--end::Actions-->
                                    </div>
                                    <!--end::Content-->
                    ...
                    <div class="card-body py-3" id="base_table">
                        ...
                        <form action="<?= base_url('master_function/drag_pendukung') ?>" method="POST" class="table-responsive" id="reload_table">
                            <!--begin::Table-->
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <thead>
                                    <tr class="fw-bold text-muted">
                                        ...
                                        <th class="min-w-200px">Pendukung</th>
                                ...
                                <tbody>
                                    ...
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="6">
                                                <center>Data pendukung tidak ditemukan</center>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                ...
                <form id="form_penduduk" class="form" action="<?= base_url('master_function/tambah_penduduk') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="#" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_penduduk_header" data-kt-scroll-wrappers="#kt_modal_penduduk_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7" id="req_id_kelurahan">
                            ...
                            <!--end::Label-->
                            <div>
                                <select name="id_kelurahan" class="form-select form-select-solid cekcek" data-control="select2" data-placeholder="Pilih kelurahan">
                                    <?php if ($kelurahan) : ?>
                        ...
                        <div class="fv-row mb-7" id="req_rt">
                            <!--begin::Label-->
