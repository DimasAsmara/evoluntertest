...
class Action_m extends CI_Model
{
    ...
    public function get_single($tabel, $array = NULL, $select = "*")
    {

        if ($array != NULL) {

            $this->db->select($select)->from($tabel)->where($array);
            ...
            $this->db->select($select)->from($tabel)->order_by($this->_order_by);
    ...
    public function sum($tabel, $sum = NULL, $array = NULL)
    {
    ...
    public function get($tabel, $array = NULL, $order, $limit = 0, $start = 0)
    {
    ...
    public function get_all($tabel, $array = NULL, $select = '*', $order = NULL)
    {
        $this->db->select($select);
        $this->db->from($tabel);
        if ($array != NULL) {
